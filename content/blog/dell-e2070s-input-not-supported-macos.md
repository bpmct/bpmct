...
Every so often the error would return — usually after sleep or unplugging. The fix that consistently worked for me was almost dumb: **just nudge the brightness**. Bumping it up or down a notch (via BetterDisplay or the monitor's own buttons) pokes the display enough to re-sync and the picture comes back.
